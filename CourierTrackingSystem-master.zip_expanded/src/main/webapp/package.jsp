...
<body>
	...
	<div class="container-fluid rules">
		...
		<div class="text-decoration-underline text-center">
			...
			<div><a class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3"
				href="userOffer.jsp" role="button">Generate offer to user from quotation</a> </div>
			<br><br>	
			<div><a class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3"
				href="packageUpdation.jsp" role="button">Package Updation</a> </div>
			<br><br>
			<div><a class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3"
				href="consignmentReceipt.jsp" role="button">Generate Consignment receipt</a> </div>
			<br><br>	
			<div><a class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3"
				href="BillGeneration.jsp" role="button">Generate
					Bill to customer</a></div>
		</div>
	</div>
