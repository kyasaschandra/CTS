...
<body>
	...
	<div class="container-fluid rules">
		...
		<div class="text-decoration-underline text-center">
			<br> <br>
			<h3 class="text-decoration-underline text-center">Generate Offer
				to Customers</h3>
		</div>
		<br> <br>
...
select * from quotation;
		...
		<form action="updateOffer" method="post">
			<table class="table-fluid" text-align="center">
				<thead>
					<tr>
				...
				<tbody>
					<c:forEach items="${rec.rows}" var="v">
						<tr>
							...
							<td>${v.QuoteDate}</td>
							<td><input type="text" name="offerdate"
								value="${v.offerDate}" /></td>
							<td><input type="text" name="distance" value="${v.distance}" /></td>
							<td><input type="text" name="cost" value="${v.cost}" /></td>
							<td><input type="text" name="expdelivdate"
								value="${v.expectedDeiveryDate}" /></td>

							<td><input type="submit" name="update"
								value="Update Quotation & Generate Offer"></td>
